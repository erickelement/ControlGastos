...
namespace ControlGastos.Servicios
{
    ...
    {
        Task<IEnumerable<ResultadoObtnerPorSemana>> ObtenerReporteSemanal(int usuarioId, int mes, int año, dynamic ViewBag);
    ...
    public class ServicioReportes: IServicioReportes
    {
        ...
        public async Task<IEnumerable<ResultadoObtnerPorSemana>> ObtenerReporteSemanal(int usuarioId, int mes,
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladas(int usuarioId, int mes, int año,
            dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int mes, int año, dynamic ViewBag)
        {
            ...
            var transacciones = await repositorioTransacciones.ObtenerPorCentaId(obtenerTransaccionesPorCuenta);
