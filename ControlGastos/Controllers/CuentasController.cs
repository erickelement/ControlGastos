    ...
    public class CuentasController: Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var modelo = cuentasConTipoCuenta
                .GroupBy(x => x.TipoCuenta) //Aqui se va agrupar por tipo cuenta
                .Select(grupo => new IndiceCuentasViewModel
                {
                    TipoCuenta = grupo.Key, //El kay representa el indice que genera la agrupacion es decir key = TipoCuenta
                    Cuentas = grupo.AsEnumerable() //Aqui estoy recieviendo el enumerable de cuentas del Tipo Cuenta
                }
                ).ToList();
