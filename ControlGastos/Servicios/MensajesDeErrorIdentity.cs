...
namespace ControlGastos.Servicios
{
    public class MensajesDeErrorIdentity: IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure() { return new IdentityError { Code = nameof(ConcurrencyFailure), Description = " Ha ocurrido un error, el objeto ya ha sido modificado (Fallo de concurrencia optimista). " }; }
        ...
        //public override IdentityError LoginYaAssociated() { return new IdentityError { Code = nameof(LoginAlreadyAssociated), Description = " Un usuario con ese nombre ya existe. " }; }
